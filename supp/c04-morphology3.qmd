---
title: "Morphology by Core Production Area"
bibliography: [book.bib]
---

```{r loadgmP, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE, message = FALSE}
...
```{r gpaP, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE, message = FALSE}
# gpa
...
```{r pca.plotColorGrouprawP, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE}
# principal components analysis
...
```{r anovaColorGrouprawP, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE}
# shape
...
```{r mshapeP, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE}
