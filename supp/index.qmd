---
title: "Did intended firing practice condition the morphology of Caddo bottles?"
author:
...
Within production-based inquiries, color is afforded primacy, as it provides evidence associated with use, raw material variability, and firing. This study is focused on the latter, and asks whether intended firing practices conditioned the morphology of Formative/Early Caddo bottles (CE 800 - 1200). Thirty three-dimensional (3-D) scans of Hickory Engraved and Smithport Plain bottles were collected from five museums and repositories, and provide 360-degree coverage of exterior colors associated with each vessel. Texture (color) files were used in a quantitative analysis of color where vessels were subsequently binned into two firing groups; oxidized and reduced. The 3-D meshes were then analyzed using the tools of geometric morphometrics to assess whether bottle shape and size differ by firing group. Results demonstrated that bottles from the two firing groups differ significantly in both color and shape, but not size. Thus, Caddo potters conditioned the shape of Hickory Engraved and Smithport Plain bottles based upon whether they were intended to be fired in an oxidized or reduced environment. This finding provides support for two discrete, and contemporary, Caddo ceramic communities of practice delimited by macroscopic production attributes, which overlap geographically, and are co-present at some sites---but never in the same burial---while not at others.
