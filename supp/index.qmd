...
For analysts of ceramics recovered from archaeological contexts, production has long been a fundamental component of their arguments. Within production-based inquiries, color is afforded primacy, as it can provide evidence for use, raw material variability, and firing. This study is focused on the latter, and asks whether intended firing practices may have conditioned the morphology of Formative/Early (CE 800 - 1200) Caddo bottles. To answer this question, 30 three-dimensional (3-D) scans of Hickory Engraved and Smithport Plain bottles were collected from five museums and repositories. The texture (color) data provide 360-degree coverage of the exterior of each vessel, and were used in a quantitative analysis of color where vessels were subsequently binned into two firing groups; oxidized and reduced. The 3-D meshes were then analyzed using the tools of geometric morphometrics to assess whether bottle shape and size differed by firing group. Results demonstrated that the Hickory Engraved and Smithport Plain bottles differ in size---but not shape---and that the two firing groups differ significantly in both color and shape, but not size. Thus, Caddo potters conditioned the shape of Hickory Engraved and Smithport Plain bottles based upon whether they were intended to be fired in an oxidized or reduced environment. 
...
Results demonstrate a significant difference in size by type (RRPP: 10,000; Rsq: 0.14223; **Pr(>F): 0.0373**), where the Hickory Engraved bottles were found to be larger than the Smithport Plain bottles. In the analysis of bottle morphology by firing group, the vessels were found to differ significantly in shape (_RRPP: 10,000; Rsq: 0.11534; **Pr(>F) = 0.0285**_), but not size, by firing group.
