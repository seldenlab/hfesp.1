...
```{r fig6, fig.cap="Principal components analysis plot (PC1/PC2) for Hickory Engraved and Smithport Plain bottles by core production areas, where gray circles indicate bottles fired in a reduced environment in the north, orange plus signs indicate those from an oxidized environment in the south, and tan plus signs indicate those from an oxidized environment in the north; warp grids for the first two principal components."}
...
This study used a quantitative analysis of 3D vessel color to demarcate oxidized and reduced Hickory Engraved and Smithport Plain bottles, demonstrating a methodologically rigorous and reproducible approach to categorizing continuous variables associated with color. Bottles in each group were found to differ in shape, but not size, and while the oxidized vessels were produced in two core areas, reduced vessels were produced in one. While ancillary to the primary research question, a morphological comparison of Hickory Engraved and Smithport Plain bottles was included in this analysis. Similarities in shape between the two types are known—and demonstrated here—however, what was not known is that Hickory Engraved bottles are significantly larger. This difference in volume may translate to a difference in which these two bottle types may have been used by the Caddo.

This finding provides evidence for two discrete, contemporary, and sympatric Caddo potting communities delimited by macroscopic production attributes, and posits differential production-based intentions among Caddo potters. While spatial overlap occurs between the oxidized and reduced core production areas in the north, the southern core production area is geographically isolated. This then begs the question of whether extant morphological differences may be apparent between the two core production areas for oxidized bottles. Using only those vessels recovered from sites in the core production areas in a subsequent comparison of bottle morphology demonstrated that the oxidized and reduced bottles from the core production areas in the north are similar, but both differ significantly from the core production area associated with oxidized bottle production in the south. Elsewhere it has been demonstrated that differences exist between ceramics [@RN11801;@RN11782;@RN11716;@RN8312], bifaces [@RN21001;@RN11783], and arrow points [@RN11172;@RN11264;@RN9364] recovered from the northern and southern Caddo behavioral regions; a theory to which this effort contributes added support. Further, the two communities of practice (morphology + firing) can be concatenated as a means of positing the possible provenance of Hickory Engraved and Smithport Plain bottles found outside of the three core production areas, where bottle shape discriminates between the northern and southern manufacturing traditions, and firing method discriminates---among the northern production areas---between the eastern (reduced) and western (oxidized) firing traditions.
