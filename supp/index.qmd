...
Site locations and color group assignments were subsequently imported to a GIS where core production areas associated with reduced and oxidized Hickory Engraved and Smithport Plain bottle manufacture were identified using kernel density plots. Following production, raster values were extracted for each point location, which were used to delimit the 50 and 75 percent quantiles for each plot. Results demonstrate a single core area related to the production of reduced bottles; however, oxidized bottle production occurred across two core areas (one north; the other south). It is noteworthy that all three core bottle production areas occur in the Red River basin.
