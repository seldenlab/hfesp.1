...
```{r loadgmtype, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE, message = FALSE}
...
```{r gpatype, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE, message = FALSE}
# gpa
...
```{r boxtype, echo=TRUE, out.width = "100%", dpi = 300, warning=FALSE}
# attributes
csz <- qdata$csz
type <- qdata$typeroup
...
```{r pcaplottyperouprawtype, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE}
# principal components analysis
...
```{r anovatyperouprawtype, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE}
# ANOVA
# shape
